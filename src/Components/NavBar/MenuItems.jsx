...
const MenuItems = ({setShowMenu}) => {
    ...
    return (
        <div className=" fixed w-[25%] sm:w-[90%] duration-500  bg-blue-500 top-0 right-0 py-[2.5%] pt-[7%] h-full z-50 cursor-default">
            ...
            <div className=' flex flex-col gap-10 p-10 justify-center rounded-md pl-[25%] text-[18px] mt-[30%]'>
