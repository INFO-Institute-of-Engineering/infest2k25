        ...
        <div className=" grid grid-cols-3 w-[85%] mx-auto md:grid-cols-1 cursor-pointer">
            {
                ElectricalCardContent.map((content)=>(
                    ...
                    <Link to={`/event/electrical/${content.eventTitle}`} key={content.eventTitle} className=" border rounded-md p-6 m-4 flex flex-col justify-between gap-4 hover:shadow-xl">
