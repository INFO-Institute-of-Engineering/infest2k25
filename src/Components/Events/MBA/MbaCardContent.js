...
const MbaCardContent = [
    ...
    },
    {
        ...
        rules:[
            "Number of participants for the event will only be 1 per college. The Best Manager will be carried in 3 different rounds and those would be conducted in 1 day at regular intervals. The probable rounds for the best manager will be as follows:",
            "Round 1: Aptitude Test.",
            "It will be conducted simultaneously for all the participants. It’s duration will be of 15 mins. Basic mathematical concepts will be tested. ",
            "Round 2: Situation Analysis.",
            ...
            "Round 3: Rapid fire round (Psychometric Test)",
            "Rapid fire round: In this Participants will be tested on individual level regarding their thought process, analyzing ability as well as stress management."
        ],
        criteria:[
    ...
    },
    {
        ...
        rules:[
            ...
            "Total 2 rounds – 30 minutes each round.",
            "Round 1: Totally 15 Questions -Choice based question.",
            "Round 2: Identify Logo, Slogan and Tagline.",
    ...
    },
    {
        ...
        rules:[
            ".Group event (4 members in a team / 2 teams from a college).",
            ".Topics are given on the spot and 20minutes time is given for preparation.",
            ".Vulgarity or offensive terms may lead to disqualification.",
            ".Time given is 3-5 minutes for the total performance.",
            ".Props and background music is allowed."
        ],
        criteria:[
            "Humor factor",
            "Team Dynamics",
    ...
    },
    {
        ...
        rules:[
            "Maximum 8 members per team / Maximum 2 teams from a college",
            "Each team will have 10 minutes to put up the show with a 1-minute stage set up.",
            "Background music to be in an mp3 format in CD/pen drive and need to be submitted to the event heads 1 hour prior to the event",
            "Technical issues and format compatibility for the audio files will be the sole responsibility of the team.",
            "It is compulsory that all participants must possess valid college ID card and be presented at the time of registration"
        ],
        criteria:[
            "Teams will be judged based on the costume, theme, walking, stance and attitude."
        ]
    },
    {
        id:7,
