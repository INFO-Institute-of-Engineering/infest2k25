    ...
    return (
        <div>
            ...
            <div>
                ...
                <video autoPlay muted loop src={BgVideo} className=" absolute top-0 object-cover w-full h-full"></video>

                <div className=" relative">
                    <div className="mx-auto mt-[10%] z-20">
                        <h1 className="text-center my-[1.5%] text-[25px] text-blue-500 font-bold" style={NotSelected}>A One Day National Level Techinal Symposium</h1>
